    ...
    <div class="site-wrapper">
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark">
                <a class="navbar-brand" href="homepage.php" style="font-family: Skranji, cursive; color: black;"><img class="myImg" src="robomotz logo-02.png"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  ...
                  <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link" style="color: black;" href="login.php"><img src="person-2x.png"><strong>Sign in</strong></a>
...
<div class="row my-4">
    <div class="col-md-4 offset-md-2">
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              <a class="a2" href="news&events.php" class="card-link">Learn more</a>
            </div>
          </div>
    </div>
    <div class="col-md-4">
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              <a class="a2" href="learn.php" class="card-link">Learn more</a>
            </div>
          </div>
    </div>
    </div>
...
<section class="section-2">
  <div class="card">
    <div class="card-body text-center">
      ...
      <p class="card-text"><small class="text-muted"><a class="a1" href="videos.php">Embark on a journey into the world of Assassin's Creed</a></small></p>
    </div>
